            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="" id="login" method="post" action="data/admindata.php" enctype="multipart/form-data" class="mt-5">
                  ...
                  <input type="text" hidden value="editdepartment" name="type">
                  ...
                  <div class="md-form">                  
                    <input type="text" id="department" class="form-control validate" name="department" data-type="general" value="<?php echo $_POST['type'];?>" >
