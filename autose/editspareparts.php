            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="" id="login" method="post" action="data/admindata.php" enctype="multipart/form-data" class="mt-5">
                  ...
                  <input type="text" hidden value="editspareparts" name="type">
                  <input type="text" hidden value="<?php echo $_POST['spareid'];?>" name="spareid">
                  ...
                  <div class="md-form">                  
                    <input type="text" id="spare" class="form-control validate" name="spare" data-type="name" value="<?php echo $_POST['spare'];?>" >
                    <label for="form3">Spare Part</label>
                  </div>
