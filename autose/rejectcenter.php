            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="" id="login" method="post" action="data/admindata.php" enctype="multipart/form-data" class="mt-5">
                  ...
                  <input type="text" hidden value="reject" name="type">
                  <input type="text" hidden value="<?php echo $_POST['licenceno'];?>" name="id">
                  ...
                  <div class="md-form">                  
                    <!-- <input type="textarea" rows="5" id="brand" class="form-control validate" name="body" placeholder> -->
                    <textarea rows="4" cols="50" name="body" class="form-control" placeholder="Write here...."></textarea>
                  </div>
