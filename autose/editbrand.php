            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="" id="login" method="post" action="data/admindata.php" enctype="multipart/form-data" class="mt-5">
                  ...
                  <input type="text" hidden value="editbrand" name="type">
                  <input type="text" hidden value="<?php echo $_POST['brandid'];?>" name="brandid">
                  ...
                  <div class="md-form">                  
                    <input type="text" id="brand" class="form-control validate" name="brandname" data-type="name" value="<?php echo $_POST['brandname'];?>" >
