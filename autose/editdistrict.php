            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="" id="login" method="post" action="data/admindata.php" enctype="multipart/form-data" class="mt-5">
                  ...
                  <input type="text" hidden value="editdistrict" name="type">
                  <input type="text" hidden value="<?php echo $_POST['districtid'];?>" name="districtid">
                  <h3 class="dark-grey-text text-center">
                    <strong>EDIT DISTRICT NAME</strong>
                  </h3>
                  <hr>

                  <div class="md-form">                  
                    <input type="text" id="district" class="form-control validate" name="district" data-type="name" value="<?php echo $_POST['district'];?>" >
